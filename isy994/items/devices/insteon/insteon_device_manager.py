...
def get_insteon_device_class(device_info):
    ...
    if device_info.category == '5' and device_info.sub_category == '10' and device_info.address_parts[3] == '1':  # temp linc (Wireless)
        return Device_Insteon_TempLinc

    if device_info.category == '5' and device_info.sub_category == '11' and device_info.address_parts[3] == '1':  # temp linc (Wired)
        return Device_Insteon_TempLinc
